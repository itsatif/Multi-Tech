...
const Miscellaneoustoolsdetails = () => {
    useEffect(() => {
        window.scrollTo(0, 0);
    }, []);
            ...
            <div className="pt-24">
                ...
                <div className="max-w-md mx-auto bg-white rounded-xl shadow-md overflow-hidden md:max-w-full mt-12 ">
                    <div className="md:flex">
                        ...
                        <div className="p-8 ">
                            ...
                            <span
                                className="block mt-2 font-kepler text-xl   leading-tight font-semibold text-black hover:underline mb-1">
                {product.name}
              </span>
                ...
                <span className="font-kepler ">
                  {" "}
                    ...
                    {" "}
                      ...
                      {product.Strippingtitle}
                            ...
                            <div>
                                {/* <div className="my-[1px]"><span className="font-kepler "> <span className="font-kepler text-[16px] font-semibold" >Material:</span> {product.material}</span></div> */}
                                <div className="my-[1px]">
                  <span className="font-kepler ">
                    {" "}
                      <span className="font-kepler text-[16px] font-semibold">
                  ...
                  {" "}
                                ...
                                {product.features && (
                                    <p className="mt-1 font-kepler normal-case">{product.features}</p>
                                )}
                                {product.features1 && (
                                    <p className="mt-1 font-kepler normal-case">{product.features1}</p>
                                )}
                                {product.features2 && (
                                    <p className="mt-1 font-kepler normal-case">{product.features2}</p>
                                )}
                                {product.features3 && (
                                    <p className="mt-1 font-kepler normal-case">{product.features3}</p>
                                )}
                                {product.features4 && (
                                    <p className="mt-1 font-kepler normal-case">{product.features4}</p>
                                )}
                                {product.features5 && (
                                    <p className="mt-1 font-kepler normal-case">{product.features5}</p>
                                )}
                                {product.features6 && (
                                    <p className="mt-1 font-kepler normal-case">{product.features6}</p>
                                )}
                                {product.features7 && (
                                    <p className="mt-1 font-kepler normal-case">{product.features7}</p>
                                )}
                            </div>
                            <div>
...
export default Miscellaneoustoolsdetails;
