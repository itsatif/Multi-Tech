...
const HexKey = () => {
  ...
  const pruningShearsProducts = Products.filter(
    (product) => product.category === "Hex keys"
  );
  ...
  return (
    <>
      <Helmet>
        <title>Hex Kyes</title>
        {/* Add any other meta tags or links you need */}
        <link rel="canonical " href="https://multitectools.com/hexkeys" />
          ...
          >
            <div>
              <div className="text-center text-black  pb-10 mb-5  pt-5  text-3xl font-medium">
                <h1 className="font-kepler italic">Hex Key</h1>
              </div>
              <div>
                      ...
                      <div className="mb-5 mt-5">
                        <div class="glassBox">
                          <div class="glassBox__imgBox ">
                            <Link
                              to={`/hexkeys-productdetail/${product.URLname}`}
                            >
                              {" "}
                              <img
