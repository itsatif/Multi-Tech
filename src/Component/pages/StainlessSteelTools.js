...
const StainLessSteelTools = () => {
  ...
  const pruningShearsProducts = Products.filter(
    (product) => product.category === "Stainless Steel Tools"
  );
  ...
  return (
    <>
      <Helmet>
        <title>Stainless Steel Tools</title>
        {/* Add any other meta tags or links you need */}
        <link
          rel="canonical "
          href="https://multitectools.com/stainlesssteeltools"
        />
        {/* <!-- Open Graph / Facebook --> */}
          ...
          >
            <div>
              <div className="text-center text-black  pb-10 mb-5  pt-5  text-3xl font-medium">
                <h1 className="font-kepler italic">Stainless Steel Tools</h1>
              </div>
              <div>
                      ...
                      <div className="mb-5 mt-5">
                        <div class="glassBox ">
                          <div class="glassBox__imgBox ">
                            <Link
                              to={`/stainlesssteeltools-productdetail/${product.URLname}`}
                            >
                              {" "}
                              <img
