...
const PowerBits = () => {
  ...
  const pruningShearsProducts = Products.filter(
    (product) => product.category === "Power bits"
  );
  ...
  return (
    <>
      <Helmet>
        <title>Power Bits</title>
        {/* Add any other meta tags or links you need */}
        <link
          rel="canonical "
          href="https://multitectools.com//nipper/PowerBits"
        />
          ...
          >
            <div>
              <div className="text-center text-black  pb-10 mb-5  pt-5  text-3xl font-medium">
                <h1 className="font-kepler italic">Power Bits</h1>
              </div>
              <div>
                      ...
                      <div className="mb-5 mt-5">
                        <div class="glassBox ">
                          <div class="glassBox__imgBox ">
                            <Link
                              to={`/powerbits-productdetail/${product.URLname}`}
                            >
                              {" "}
                              <img
