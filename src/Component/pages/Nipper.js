...
const Nipper = () => {
    ...
    const pruningShearsProducts = Products.filter(
        (product) => product.category.trim() === "Nippers & Micro- Shears" || product.category === "NIPPERS & MICRO SHEARS"
    );
    ...
    return (
        <>
            <Helmet>
                <title>Nipper And Micro Shears</title>
                {/* Add any other meta tags or links you need */}
                <link
                    rel="canonical "
                    href="https://multitectools.com/nipper-micro&shears"
                />
                    ...
                    >
                        <div>
                            <div className="text-center text-black  pb-10 mb-5  pt-5  text-3xl font-medium">
                                <h1 className="font-kepler italic"> Nippers & Micro- Shears</h1>
                            </div>
                            <div>
                                <div className="flex flex-wrap w-auto justify-center text-center items-center">
                                    {productsToDisplay.map((product) => (
                                        <div
                                            className="justify-center items-center px-5 flex text-center  border-b-2"
                                            key={product.id}
                                        >
                                            <div className="mb-5 mt-5">
                                                <div class="glassBox">
                                                    <div class="glassBox__imgBox ">
                                                        <Link
                                                            to={`/nipper-micro&shears-productdetail/${product.URLname}`}
                                                        >
                                                            {" "}
                                                            <img
                                                ...
                                                <div className="flex text-center justify-center">
                                                    ...
                                                    >
                                                        <button
                                                            className="px-4 py-2 mt-5  text-white text-lg font-sans bg-red-700
