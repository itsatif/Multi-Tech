...
const GardernTools = () => {
  ...
  const pruningShearsProducts = Products.filter(
    (product) => product.category === "Garden & Agro Tools"
  );
  ...
  return (
    <>
      <Helmet>
        <title>Gardens & Argo Tools</title>
        {/* Add any other meta tags or links you need */}
        <link rel="canonical " href="https://multitectools.com/gardentools" />
          ...
          >
            <div>
              <div className="text-center text-black  pb-10 mb-5  pt-5  text-3xl font-medium">
                <h1 className="font-kepler italic">Garden & Agro Tools</h1>
              </div>
              <div>
                      ...
                      <div className="mb-5 mt-5">
                        <div class="glassBox ">
                          <div class="glassBox__imgBox ">
                            <Link
                              to={`/gardentools-productdetail/${product.URLname}`}
                            >
                              {" "}
                              <img
                          ...
                          >
                            <button
                              className="px-4 py-2 mt-5 rounded text-white text-lg font-sans bg-red-700
                                                    shadow-[0_9px_0_rgb(0,0,0)] hover:shadow-[0_4px_0px_rgb(0,0,0)] t ease-out hover:translate-y-1 transition-all "
                            >
                              View Details
                            </button>
                          </Link>
