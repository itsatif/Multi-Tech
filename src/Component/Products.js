export const Products = [
  ...
  },
  {
    ...
    caution: ["Sharp blades - keep out of children.", "Do not cut live wires."],
    maintenanceTitle: "Maintenance:",
    maintenance: [
      "Keep blades clean.",
      "Swipe with oil after use.",
      "Store in a dry place.",
    ],
    URL: "Collase of Garden tools.webp",
    category: "Garden & Agro Tools",
    features: [
      "Ultra-sharp Stainless Steel Blades ensure efficient cutting performance.",
      "Handles designed to fit palm bends for comfortable use.",
      "Lightweight Plastic handles for ease of handling.",
      "Easy locking mechanism when not in use.",
    ],
  },
  {
    id: 42,
    ...
    category: "Garden & Agro Tools",
    features: [
      "Blades are duly hardened & tempered.",
      "Blades sharpened and adjusted to cut & trim hedges at ease.",
      "Aluminium alloy handle with soft grips makes it suitable to use for continuous work.",
    ],
  },
  {
    id: 43,
    ...
    features: [
      "Blades are duly hardened & tempered.",
      "Blades sharpened and adjusted to cut & trim hedges at ease.",
      "Lightweight Plastic handles make it suitable for continuous work.",
      "Lightweight - suitable to use for extended periods.",
    ],
  },
  {
    id: 45,
    ...
    features: [
      "Blades are duly hardened & tempered.",
      "Blades sharpened and adjusted to cut & trim hedges at ease.",
      "Extendable aluminium alloy handles with soft grips.",
      "Suitable to cut hedges at height by extending the handles.",
    ],
  },
  {
    id: 49,
    ...
    features: [
      ...
      "2. Extendable aluminium alloy handles.",
      "3. Light weight, heavy duty construction.",
    ],
  ...
  },
  {
    ...
    application: [
      "Sturdy tool for weeding, hoeing and making trenches, Suitable in gardens, fields in and around bushy shrubs and plants",
    ],
  },
  {
    id: 99,
    ...
    application: [
      "Designed for easy loosening and ventilation of soils , Effortless use in narrow bed rows capacitating optimum supply of nutrients, Back face angle of the tool head effortlessly draw through the soil ",
    ],
  },
  {
    id: 100,
    ...
    application: [
      "For making ridges, furrows and irrigation channels in fields, Easy to use for large scale vegetable growers ",
    ],
  },
  {
    id: 101,
  ...
  },
  {
    ...
    application: [
      "Prongs used for loosening the soil, Opposite side Hoe used for hoeing-cultivating and weeding of the soil, Suitable for pulling seed grooves",
    ],
  },
  {
    id: 104,
    ...
    application: [
      "Prongs used for loosening the soil, Opposite side Hoe used for hoeing-cultivating and weeding of the soil",
    ],
  },
  {
    id: 105,
    ...
    application: [
      "Heavy duty Prongs used for loosening the tough soil, Opposite side Hoe used for hoeing-cultivating and weeding of the soil",
    ],
  },
  {
    id: 106,
  ...
  },
  {
    ...
    application: [
      "Designed for removing deep rooted weeds from base, Knife end is inserted by thrusting into the soil exerting force on foot rest. The weed is pulled out without harming the plant. ",
    ],
  },
  {
    id: 108,
  ...
  },
  {
    ...
    application: [
      "Designed to weed light and sandy soils effortlessly, Two-way blades cut through weeds on the pull and push stroke below the soil",
    ],
  },
  {
    id: 110,
    ...
    application: [
      " For clearing large field beds effortlessly, For heavy duty works",
    ],
  },
  {
    id: 111,
    ...
    application: [
      "For clearing tough large field beds effortlessly, For heavy duty works",
    ],
  },
  {
    id: 112,
  ...
  },
  {
    ...
    application: ["Trimming of bushes", "Creating and maintaining hedges"],
    technical: ["Blade Length 10", "Overall Length: 580mm (approx.)"],
    URL: "Collase of Garden tools.webp",
    category: "Garden & Agro Tools",
  },
  {
    ...
    technical: ["Blade Length 10", "Overall length: 870mm(approx.)"],
    URL: "Collase of Garden tools.webp",
    category: "Garden & Agro Tools",
  },
  {
  ...
  },
  {
    ...
    application: ["Trimming of bushes", "Creating and maintaining hedges"],
    technical: ["Blade Length 10", "Overall length: 545mm(approx.)"],
    URL: "Collase of Garden tools.webp",
    category: "Garden & Agro Tools",
  },
  {
  ...
  },
  {
    ...
    precautions: [
      "Fully open jaw-anvil and place/hold job from below and then cut.",
      "Cut branches keeping both hands in symmetry. Do not twist the lopper whilecutting",
    ],
    technical: [
      "Cutting Capacity: 40mm",
  ...
  },
  {
    ...
    technical: ["Cutting Capacity: 30mm", "Overall length 15"],
    URL: "Collase of Garden tools.webp",
    category: "Garden & Agro Tools",
  },
  {
